...
description: 'It can be challenging sometimes to know how best to persist value objects to a data store, especially if you are using a RDBMS. There are a variety of options to choose from, however, depending on your needs and constraints.'
pubDate: 'Jan 22 2015'
heroImage: '../../assets/persisting-value-objects/cargo.webp'
---
...
![Cargo entity and associated value objects](../../assets/persisting-value-objects/cargo.webp)
...
|-----|---------------------------|------------------|----------------------------|
| **Inline in Entity Table** | **1-to-1**: Good O-R mapper support. Straightforward object/DB schema versioning. Factoring fields into Value Object doesn't change DB schema | **1-to-Many/1-to-1 Complex**: Version management of serialization. Some performance concerns. Query limitations. Field length limitations | **Document Id**: Hybrid approach – store document Id in Entity's table and lookup in Repository. Queries supported by document databases |
| **Separate Table** | **1-to-Many**: Good O-R mapper support, but must put ID field in Value Object. Straightforward object/DB schema versioning | — | — |
